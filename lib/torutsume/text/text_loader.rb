      ...
      def load(text)
        ...
        blame.each do |hunk|
          hunk.each do |line|
            ...
            lines << ::Torutsume::Text::Line.new(content: line.content, line_number: line_number, comments: comments, commit_id: line.commit_id, orig_line_number: line.orig_line_number)
            line_number += 1
          end
        end
